...
export type action = LoadCustomers | LoadCustomersFail | LoadCustomersSuccess | LoadCustomer | LoadCustomerSuccess | LoadCustomerFail | CreateCustomer | CreateCustomerFail | CreateCustomerSuccess | UpdateCustomer | UpdateCustomerFail | UpdateCustomerSuccess | DeleteCustomer | DeleteCustomerFail | DeleteCustomerSuccess;